    ...
    return (
        <>
            <IonCard style={{paddingBottom: '14px', paddingTop: '24px', marginBottom: '0', backgroundColor: '#fff5d7'}}>
                ...
                Es ist etwas seltenes und so rares, dass ich es nicht einfach auch schicken konnte. Die Gefahr, dass es jemand stehlen würde, wäre zu groß. Es ist an einem sicheren Ort versteckt. Ich habe dir aber Hinweise, verschlüsselte Botschaften und Rätsel hinterlassen, damit du es finden kannst.
                        <br/>
                        Einfach wird es nicht werden, aber manchmal ist ja auch der Weg das Ziel.
                        <br/> <br/>
