...
export const FriedenskircheFakten: React.FC<StepProps> = ({goToNextStep}) => {
    return (
        <IonCardContent>
            ...
            Als für die Olympische Spiele 1972 in München die Bauarbeiten am Oberwiesenfeld begannen, wurde das Olympiagelände extra weiter nördlich gelegt als geplant, um die kleine Kirche zu erhalten. <br/><br/>
